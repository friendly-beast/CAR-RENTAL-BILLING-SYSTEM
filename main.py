...
menu_category = ["MINI CARS", "SEDAN CARS",
                 "SUV CARS", "ELECTRIC CARS"]

menu_category_dict = {"MINI CARS": "minicars.txt",
                      "SEDAN CARS": "sedan cars.txt",
                      "SUV CARS": "suvcars.txt",
                      "ELECTRIC CARS": "electriccars.txt"
                      }
...
def add_button_operation():
    ...
    if name in order_dict[category].keys():
        tmsg.showinfo("Error", "Item already exists in your order")
        print(order_dict[category].keys())
        return
...
def bill_button_operation():
    ...
    if not customerContact.get().isdigit():
        tmsg.showinfo("Error", "Invalid Contact No")
        return
...
root.title("Welcome to Car Rental Billing System")
root.wm_iconbitmap("carrentallogo.ico")
...
title_label = Label(title_frame, text="BOSS CAR RENTALS", font=(
    "times new roman", 22, "bold"), bg="black", fg="yellow", pady=5)
title_label.pack()

# ==============Customer=============
customer_frame = LabelFrame(root, text="Customer Details", font=("times new roman", 15, "bold"),
                            bd=8, bg="darkgrey", relief=GROOVE)
...
customer_contactno_label = Label(customer_frame, text="Contact No :",
                               font=("arial", 15, "bold"), bg="lightgrey", fg="blue")
customer_contactno_label.grid(row=0, column=2)
...
# ===============Menu===============
menu_frame = Frame(root, bd=8, bg="darkgrey", relief=GROOVE)
menu_frame.place(x=0, y=125, height=585, width=680)

menu_label = Label(menu_frame, text="Car Rental Details",
                   font=("times new roman", 20, "bold"), bg="black", fg="lightgreen", pady=0)
menu_label.pack(side=TOP, fill="x")

menu_category_frame = Frame(menu_frame, bg="darkgrey", pady=10)
...
# ===============Item Frame=============
item_frame = Frame(root, bd=8, bg="darkgrey", relief=GROOVE)
item_frame.place(x=680, y=125, height=230, width=680)

item_title_label = Label(item_frame, text="Car Rental Billing Desk",
                         font=("times new roman", 20, "bold"), bg="black", fg="lightgreen")
...
# ==============Order Frame=====================
order_frame = Frame(root, bd=8, bg="darkgrey", relief=GROOVE)
